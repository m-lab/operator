...
site_list = [
    ...
    makesite('tgd01','213.149.127.0',   '2a00:fe80:0:104::',   'Podgorica', 'ME', 42.107764, 18.761649, user_list, count=4, arch='x86_64-r630', nodegroup='MeasurementLabCentos', roundrobin=False),
