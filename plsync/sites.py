...
site_list = [
    ...
    makesite('atl02','38.112.151.64',  '2001:550:5B00:1::',    'Atlanta GA', 'US', 33.636700, -84.428100, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('iad02','38.90.140.128',  '2001:550:200:7::',     'Ashburn VA', 'US', 38.944400, -77.455800, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('lga02','38.106.70.128',  '2001:550:1D00:100::',  'New York', 'US', 40.766700, -73.866700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('mia02','38.109.21.0',    '2001:550:6C01::',      'Miami', 'US', 25.783300, -80.266700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('ord02','38.65.210.192',  '2001:550:1B01:1::',    'Chicago', 'US', 41.978600, -87.904700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('sjc01','38.102.163.128', '2001:550:1502::',      'San Jose', 'US', 37.364200, -121.928900, user_list, count=4, nodegroup='MeasurementLabCentos'),
