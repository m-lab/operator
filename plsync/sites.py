...
site_list = [
    ...
    makesite('bcn01','91.213.30.192',   '2001:67c:137c:5::',   'Barcelona', 'ES', 41.2974, 2.0833, user_list, count=4, arch='x86_64-r630', nodegroup='MeasurementLabCentos'),
    ...
    makesite('par04','77.67.119.129',  '2001:668:1f:6b::',     'Paris', 'FR', 48.858400, 2.349010, user_list, count=4, arch='x86_64-r630', nodegroup='MeasurementLabCentos'),
