...
site_list = [
    ...
    makesite('yul01','162.219.177.0',  '2620:10a:80fe::',      'Montreal', 'CA', 45.4576, -73.7497, user_list, nodegroup='MeasurementLabCentos'),
    makesite('yyc01','162.219.178.0',  '2620:10a:80ff::',      'Calgary', 'CA', 51.1315, -114.0106, user_list, nodegroup='MeasurementLabCentos'),
    makesite('yyz01','162.219.176.0',  '2620:10a:80fd::',      'Toronto', 'CA', 43.6767, -79.6306, user_list, nodegroup='MeasurementLabCentos'),
