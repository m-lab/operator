...
site_list = [
    ...
    makesite('mpm01','41.94.23.0',      None,                  'Maputo', 'MZ', -25.9208, 32.5725, user_list, count=4, arch='x86_64-r630', exclude=[1,2,3,4], nodegroup='MeasurementLabCentos', roundrobin=True),
