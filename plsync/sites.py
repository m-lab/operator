...
site_list = [
    ...
    makesite('atl04','173.205.0.192',  '2001:0668:001F:001C::','Atlanta_GA', 'US', 33.636700, -84.428100, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('den01','184.105.23.64',  '2001:470:1:250::',     'Denver_CO', 'US', 39.856100, -104.673700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('den02','4.34.58.0',      '2001:1900:2200:49::',  'Denver_CO', 'US', 39.856100, -104.673700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('den03','65.46.46.128',   '2610:0018:010e:8003::','Denver_CO', 'US', 39.856100, -104.673700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('den04','128.177.109.64', '2001:438:fffd:2c::',   'Denver_CO', 'US', 39.856100, -104.673700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('dfw04','208.177.76.64',  '2610:0018:010E:0002::',  'Dallas_TX', 'US', 32.896900, -97.038100, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('lax03','173.205.3.64',   '2001:0668:001F:001E::','Los Angeles_CA', 'US', 33.942500, -118.407200, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('lga04','173.205.4.64',   '2001:0668:001F:0022::','New York_NY', 'US', 40.766700, -73.866700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('mia04','173.205.3.128',  '2001:0668:001F:001F::','Miami_FL', 'US', 25.783300, -80.266700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('nuq01','64.9.225.128',   '2604:ca00:f000::',     'San Francisco Bay Area_CA', 'US', 37.383300, -122.066700, user_list, count=4, v6gw='2604:ca00:f000::129', nodegroup='MeasurementLabCentos'),
    ...
    makesite('nuq05','216.156.85.192', '2610:0018:0111:0007::','San Francisco Bay Area_CA', 'US', 37.383300, -122.066700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('ord04','173.205.3.192',  '2001:0668:001F:0020::','Chicago_IL', 'US', 41.978600, -87.904700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('ord05','128.177.163.0',  '2001:438:fffd:2f::',   'Chicago_IL', 'US', 41.978600, -87.904700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('sea03','173.205.3.0',    '2001:0668:001F:001D::','Seattle_WA', 'US', 47.448900, -122.309400, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('sea05','64.3.225.64',    '2610:0018:0114:4001::','Seattle_WA', 'US', 47.448900, -122.309400, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
