...
site_list = [
    ...
    makesite('atl02','38.112.151.64',  '2001:550:5B00:1::',    'Atlanta_GA', 'US', 33.636700, -84.428100, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('atl03','64.86.200.192',  '2001:5a0:3b02::',      'Atlanta_GA', 'US', 33.636700, -84.428100, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('iad02','38.90.140.128',  '2001:550:200:7::',     'Washington_DC', 'US', 38.944400, -77.455800, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('iad03','66.198.10.128',  '2001:5a0:3c03::',      'Washington_DC', 'US', 38.944400, -77.455800, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('lga03','64.86.148.128',  '2001:5a0:4300::',      'New York_NY', 'US', 40.766700, -73.866700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('mia02','38.109.21.0',    '2001:550:6C01::',      'Miami_FL', 'US', 25.783300, -80.266700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('mia03','66.110.73.0',    '2001:5a0:3801::',      'Miami_FL', 'US', 25.783300, -80.266700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('ord02','38.65.210.192',  '2001:550:1B01:1::',    'Chicago_IL', 'US', 41.978600, -87.904700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('ord03','66.198.24.64',   '2001:5a0:4200::',      'Chicago_IL', 'US', 41.978600, -87.904700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('sea02','63.243.224.0',   '2001:5a0:4400::',      'Seattle_WA', 'US', 47.448900, -122.309000, user_list, nodegroup='MeasurementLabCentos'),
    makesite('sin01','180.87.97.64',   '2405:2000:301::',      'Singapore', 'SG', 1.3000, 103.8000, user_list, nodegroup='MeasurementLabCentos'),
    makesite('sjc01','38.102.163.128', '2001:550:1502::',      'San Jose_CA', 'US', 37.364200, -121.928900, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('sjc02','66.110.32.64',   '2001:5a0:3e00::',      'San Jose_CA', 'US', 37.364200, -121.928900, user_list, count=4, nodegroup='MeasurementLabCentos'),
    ...
    makesite('yul01','162.219.49.0',   '2620:10a:80fe::',      'Montreal', 'CA', 45.4576, -73.7497, user_list, nodegroup='MeasurementLabCentos'),
    makesite('yyc01','162.219.50.0',   '2620:10a:80ff::',      'Calgary', 'CA', 51.1315, -114.0106, user_list, nodegroup='MeasurementLabCentos'),
    makesite('yyz01','162.219.48.0',   '2620:10a:80fd::',      'Toronto', 'CA', 43.6767, -79.6306, user_list, nodegroup='MeasurementLabCentos'),
