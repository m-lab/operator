...
site_list = [
    ...
    makesite('fra01','80.239.199.0',   '2001:2030:2f::',       'Paris', 'FR', 48.8588376,2.2773457, user_list, count=4, arch='x86_64-r630', nodegroup='MeasurementLabCentos'),
    makesite('fra02','77.67.114.0',    '2001:0668:001F:005E::','Paris', 'FR', 48.8588376,2.2773457, user_list, count=4, arch='x86_64-r630', nodegroup='MeasurementLabCentos'),
    makesite('fra03','195.89.146.64',  '2001:5001:200:30::',   'Paris', 'FR', 48.8588376,2.2773457, user_list, count=4, arch='x86_64-r630', nodegroup='MeasurementLabCentos'),
    makesite('fra04','62.67.198.192',  '2001:4c08:2003:40::',  'Paris', 'FR', 48.8588376,2.2773457, user_list, count=4, arch='x86_64-r630', nodegroup='MeasurementLabCentos'),
