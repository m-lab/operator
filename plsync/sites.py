...
site_list = [
    ...
    makesite('nuq03','38.102.163.128', '2001:550:1502::',      'San Jose_CA', 'US', 37.364200, -121.928900, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('nuq04','66.110.32.64',   '2001:5a0:3e00::',      'San Jose_CA', 'US', 37.364200, -121.928900, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
