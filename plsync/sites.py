...
site_list = [
    ...
    makesite('lax05','128.177.109.192','2001:438:fffd:2e::',   'Los Angeles_CA', 'US', 33.942500, -118.407000, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('nuq01','64.9.225.128',   '2604:ca00:f000::',     'San Francisco Bay Area_CA', 'US', 37.383300, -122.067000, user_list, count=4, v6gw='2604:ca00:f000::129', nodegroup='MeasurementLabCentos'),
    makesite('nuq02','149.20.5.64',    '2001:4F8:1:1001::',    'San Francisco Bay Area_CA', 'US', 37.383300, -122.067000, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('nuq03','38.102.163.128', '2001:550:1502::',      'San Francisco Bay Area_CA', 'US', 37.383300, -122.067000, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('nuq04','66.110.32.64',   '2001:5a0:3e00::',      'San Francisco Bay Area_CA', 'US', 37.383300, -122.067000, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('nuq06','128.177.109.128','2001:438:fffd:2d::',   'San Francisco Bay Area_CA', 'US', 37.383300, -122.067000, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('sea03','173.205.3.0',    '2001:0668:001F:001D::','Seattle_WA', 'US', 47.448900, -122.309000, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
