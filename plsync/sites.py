...
site_list = [
    ...
    makesite('den03','65.46.46.128',   '2610:18:10e:8003::',   'Denver_CO', 'US', 39.856100, -104.673700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('ord04','173.205.3.192',  '2001:668:1f:20::',     'Chicago_IL', 'US', 41.978600, -87.904700, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
