...
site_list = [
    ...
    makesite('mad02','213.242.96.128','2001:4c08:2003:3e::',   'Madrid', 'ES', 40.466700, -3.566670, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('mad03','80.239.229.128','2001:2030:34::',        'Madrid', 'ES', 40.466700, -3.566670, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    makesite('mad04','77.67.115.64','2001:0668:001F:0063::',   'Madrid', 'ES', 40.466700, -3.566670, user_list, count=4, arch='x86_64', nodegroup='MeasurementLabCentos'),
    ...
    makesite('prg02','195.122.159.128','2001:4c08:2003:42::',  'Prague', 'CZ', 50.083300, 14.416700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('prg03','80.239.156.128', '2001:2030:31::',       'Prague', 'CZ', 50.083300, 14.416700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('prg04','77.67.114.128',  '2001:0668:001F:0060::','Prague', 'CZ', 50.083300, 14.416700, user_list, count=4, nodegroup='MeasurementLabCentos'),
    makesite('prg05','195.89.147.64',  '2001:5016:100:3::',    'Prague', 'CZ', 50.083300, 14.416700, user_list, count=4, nodegroup='MeasurementLabCentos'),
